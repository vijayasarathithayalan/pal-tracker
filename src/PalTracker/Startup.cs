...
namespace PalTracker
{
    public class Startup
    {
        ...
        {
            services.AddCloudFoundryActuators(Configuration, MediaTypeVersion.V2, Steeltoe.Management.Hypermedia.ActuatorContext.ActuatorAndCloudFoundry);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCloudFoundryActuators(MediaTypeVersion.V2, Steeltoe.Management.Hypermedia.ActuatorContext.ActuatorAndCloudFoundry);
